...
void main() async {
  ...
  runApp(FlashcardqaApp(controller: controller));
}

class FlashcardqaApp extends StatelessWidget {
  final FlashcardqaController controller;
  FlashcardqaApp({required this.controller});

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: FlashcardqaPage(controller: controller),
    );
  }
}
